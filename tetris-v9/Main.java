...
System.out.println(Blocks.offsetX+" "+Blocks.offsetY);
	...
	public void paint(Graphics g) {
		...
		Color colors[] = { new Color(80, 80, 80), new Color(255, 255, 255), new Color(255, 50, 50), new Color(50, 255, 50),
				new Color(50, 50, 255), new Color(225, 225, 50), new Color(225, 50, 225), new Color(50, 225, 225),
				new Color(250, 170, 0), new Color(255, 50, 50, 50), new Color(50, 255, 50, 50),
				new Color(50, 50, 255, 50), new Color(225, 225, 50, 50), new Color(225, 50, 225, 50), new Color(50, 225, 225, 50),
				new Color(250, 170, 0, 50)  };

		// black0,white1,red2,green3,blue4,yellow5,purple6,cyan7,orange8,    ,red9,green10,blue11,yellow12,purple13,cyan14,orange15,
