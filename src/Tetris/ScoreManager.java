...
public class ScoreManager {
	...
	public void saveScore() {
		...
		try {
			FileWriter myWriter = new FileWriter(
					new File(System.getProperty("user.home"), "TetrisSaves.dat")
			);
	...
	public void getHighScore() {
		...
		try {
			File myObj = new File(System.getProperty("user.home"), "TetrisSaves.dat");
			...
			if (myObj.createNewFile()) {
				...
				try {
					myObj = new File(System.getProperty("user.home"), "TetrisSaves.dat");
