...
public class Render extends JPanel {
	...
	// colors
	private static final Color colors[] = { new Color(80, 80, 80), new Color(255, 255, 255), new Color(255, 50, 50),
	...
	private static final int[] ColorWave1 = { 2, 3, 4, 5, 6, 7 };
	private static final int[] ColorWave2 = { 7, 2, 3, 4, 5, 6 };
	private static final int[] ColorWave3 = { 6, 7, 2, 3, 4, 5 };
	private static final int[] ColorWave4 = { 5, 6, 7, 2, 3, 4 };
	private static final int[] ColorWave5 = { 4, 5, 6, 7, 2, 3 };
	private static final int[] ColorWave6 = { 3, 4, 5, 6, 7, 2 };
	...
	public void paint(Graphics g) {
		...
		if (gsm.CurrentState != State.GameOver) {

			if (gsm.CurrentState == State.Game || gsm.CurrentState == State.Pause) {
				...
				if (gsm.CurrentState == State.Pause) {
			...
			} else if (gsm.CurrentState == State.Menu) {
			...
			} else if (gsm.CurrentState == State.Help) {
				// Help
			...
			} else if (gsm.CurrentState == State.Splash) {
				// splash screen
			...
			} else if (gsm.CurrentState == State.Next) {
